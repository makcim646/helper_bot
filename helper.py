...
class Helper():
    ...
    def __init__(self, login, password):
        ...
        self.sesion = self.s.post(self.url, data={"act":"login", "login":"{}".format(login), "password":"{}".format(password)})
    ...
    def paswd(self, login):
        ...
        try:
            ...
            print(e)
            return "Не могу получить пароль"
    ...
    def tv_info(self, login_tv):
        ...
        try:
            ...
            print(e)
            return "Не удалось удалить получить информацию"
    ...
    def see_split(self, port, n):
        ...
        try:
            ...
            print(e)
            return "Не удалось проверить сплитер"
    ...
    def see_olt_port(self, port):
        ...
        try:
            ...
            print(e)
            return "Не удалось проверить порт OLT"
    
    
    
    def update_session(self):
        self.sesion = self.s.post(self.url, data={"act":"login", "login":"{}".format(self.log), "password":"{}".format(self.password)})
